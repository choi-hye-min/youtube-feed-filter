...
6. Watch your feed refresh as old videos are automatically removed.
...
- **뤼퀴드 글래스 팝업 UI**: 글래스 스타일 대시보드, 실시간 상태 배지, 최근 활동 목록으로 설정을 더 직관적으로 관리할 수 있습니다.
...
6. 오래된 영상들이 자동으로 사라지며 피드가 정리되는 것을 확인하세요.
